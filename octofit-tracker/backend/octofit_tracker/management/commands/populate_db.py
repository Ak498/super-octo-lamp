...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Create activities
        Activity.objects.create(user=users[0], type='Running', duration=30, calories=300, date='2025-11-28')
        Activity.objects.create(user=users[1], type='Pushups', duration=20, calories=150, date='2025-11-28')
        Activity.objects.create(user=users[3], type='Deadlift', duration=45, calories=400, date='2025-11-28')
